...
!define UOSHORTVERSION        "402"
!define UOLONGVERSION         "0.31.55"
...
WriteRegStr HKLM "${REG_UNINSTALL}\Components\MOD98" "CREATOR" "Marck, ShaggyZE, Draconis, Fl0rn, Chacha and Xeme"
