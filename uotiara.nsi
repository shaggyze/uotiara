...
!define UOSHORTVERSION        "426"
!define UOLONGVERSION         "0.45.63"
...
WriteRegStr HKLM "${REG_UNINSTALL}\Components\MOD96" "CREATOR" "Amaretto and ShaggyZE"
...
WriteRegStr HKLM "${REG_UNINSTALL}\Components\MOD98" "CREATOR" "Marck, ShaggyZE, Draconis, Fl0rn, Chacha and more"
...
;WriteRegStr HKLM "${REG_UNINSTALL}\Components\MOD98?1" "CREATOR" "Marck, ShaggyZE, Draconis, Fl0rn, Chacha and Xeme"
...
WriteRegStr HKLM "${REG_UNINSTALL}\Components\MOD161" "CREATOR" "Arcane and kirbysama"
...
WriteRegStr HKLM "${REG_UNINSTALL}\Components\MOD162" "CREATOR" "Arcane and kirbysama"
...
WriteRegStr HKLM "${REG_UNINSTALL}\Components\MOD431" "" "AutoBot (fossil restoration and updates Mods)"
...
Call UOTiaraPack
StrCpy $R7 '"$INSTDIR\mabi-pack2\mabi-pack2.exe" pack -i "$INSTDIR\UOTiara" -o "$INSTDIR\package\uotiara_00001.it" -k "})wWb4?-sVGHNoPKpc"'
Call UOTiaraPack
