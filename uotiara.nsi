!define UOSHORTVERSION        "380"
!define UOLONGVERSION         "0.13.31"
...
SetOutPath "$INSTDIR\Hyddwn Launcher\Plugins"
File "${srcdir}\Tiara's Moonshine Mod\Tools\Hyddwn\Plugins\HyddwnLauncher.PizzaHut.dll"
