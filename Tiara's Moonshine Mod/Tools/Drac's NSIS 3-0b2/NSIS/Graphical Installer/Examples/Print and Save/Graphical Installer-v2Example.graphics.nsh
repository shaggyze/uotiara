...
; License page selection 
!define MUI_LICENSEPAGE_RADIOBUTTONS true
 
; Print button on License page
!define GRAPHICAL_INSTALLER_PRINT_LICENSE "readme.txt"
 
; Save button on License page
!define GRAPHICAL_INSTALLER_SAVE_LICENSE "readme.txt"
