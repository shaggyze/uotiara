...
!define PRODUCT_NAME "Graphical Installer 'Visual & Installer' Example"
...
Name "${PRODUCT_NAME}" "Graphical Installer 'Visual && Installer' Example"
OutFile "VisualInstallerExample.exe"
