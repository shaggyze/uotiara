...
While 1
	...
	Sleep ($Delay)
		...
		Case $Button7
			...
			;========================================================
		Case $autoscanCHK[0]
			IniWrite("Restoration.ini", "Fossil Settings", "autoscan", GUICtrlRead($autoscanCHK[0]))
		Case $autoscanCHK[1]
			IniWrite("Mining.ini", "Fossil Settings", "autoscan", GUICtrlRead($autoscanCHK[1]))
			;========================================================
...
Func _readINI()
	...
	$autoscan = IniRead("Restoration.ini", "Fossil Settings", "autoscan", "1")
